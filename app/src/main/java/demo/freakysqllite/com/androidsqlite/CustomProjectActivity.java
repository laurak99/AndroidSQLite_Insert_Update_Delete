...
public class CustomProjectActivity extends BaseAdapter {

    Context c;
    ArrayList<UserModel> users;

    public CustomProjectActivity(Context c, ArrayList<UserModel> users) {
        this.c = c;
        this.users = users;
    }
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        if(view==null)
        {
            view= LayoutInflater.from(c).inflate(R.layout.activity_custom_project,viewGroup,false);
        }
